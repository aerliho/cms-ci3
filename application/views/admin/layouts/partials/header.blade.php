                ...
                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround">
                    <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                        <li class="kt-nav__item kt-nav__item--active">
                            <a href="#" class="kt-nav__link">
                                <span class="kt-nav__link-icon">
                                    <img src="{{$base_url}}assets/media/flags/020-flag.svg" alt="" /> </span>
                        ...
                        <li class="kt-nav__item">
                            <a href="#" class="kt-nav__link">
                                <span class="kt-nav__link-icon">
                                    <img src="{{$base_url}}assets/media/flags/016-spain.svg" alt="" /> </span>
                        ...
                        <li class="kt-nav__item">
                            <a href="#" class="kt-nav__link">
                                <span class="kt-nav__link-icon">
                                    <img src="{{$base_url}}assets/media/flags/017-germany.svg" alt="" /> </span>
...
@section('bottom_page')
    @parent
    <!-- begin::Quick Panel --> 
    @yield('quick_panel',$CI->blade->make('admin.layouts.partials.quick_panel'))
